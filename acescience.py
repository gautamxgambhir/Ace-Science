...
def generate_response_ow(user_input, datafile):
    ...
    system_instruction = {
        ...
        "content": (
            ...
            "\n\n"
            "### Guidelines for Generating Questions: "
            " - generate questions like, you give the define, and user answers what that thing is"
            " - proper competency one-word answers should be there."
            " - avoid questions which have answers as True or False"
            " - make sure the questions you give have sufficient information to answer the question"
            " - 100% of the questions should be one word answers type. "
            "- make the questions a bit tricky, and tough to answer too"
            "- Ensure the statements are realistic and plausible to challenge the user. For example: "
            "  - Text: 'How many chambers does a human heart has?.' "
